...
| TC-478 → TC-483 | Owner supply-shop API: tier math + 25% spread, X-Restaurant-Id tenancy, gift-card gate on search, list strips internals, proof refusals, cancel twice                                                                                                                                                                                                                                                                                                                                                                                                                                                | Owner (API)              | ✅ Written (2026-08-28)                                                                                                                   |

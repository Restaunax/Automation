...
| TC-418 → TC-425 | Waitlist + public self-service booking API (POS, throwaway tenant): waitlist notify/seat, public STRICT-mode availability + create + manage-cancel (409, not the owner surface's 400), `onlineBookingEnabled` gate (`pos/07-waitlist-public.spec.ts`)                                                                                                                                                                                                                      | POS                      | ✅ Passing (2026-08-27)                                                                                                                   |

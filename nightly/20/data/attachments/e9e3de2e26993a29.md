...
Call log:
  ...
  - waiting for locator('input[name="value"]')
    3 × locator resolved to <input value="" id="_r_76_" required="" name="value" type="number" aria-invalid="false" class="MuiInputBase-input MuiOutlinedInput-input MuiInputBase-inputAdornedStart css-5dhmgj"/>
      - unexpected value ""

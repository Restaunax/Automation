...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 9ce749fc — Miami — Print Shop
  - paragraph: Automation Owner2 Store 9ce749fc
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 9ce749fc"
  - tablist:
    - tab "Browse"

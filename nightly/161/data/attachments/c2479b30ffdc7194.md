...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 034716ef — Miami — Print Shop
  - paragraph: Automation Owner2 Store 034716ef
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 034716ef"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a8b24cb4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a8b24cb4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a8b24cb4"
  - tablist:
    - tab "Browse"

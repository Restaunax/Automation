...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 6e01c9e3 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 6e01c9e3
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 6e01c9e3"
  - tablist:
    - tab "Browse"

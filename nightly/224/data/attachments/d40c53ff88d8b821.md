...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 497d6be9 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 497d6be9
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 497d6be9"
  - tablist:
    - tab "Browse"

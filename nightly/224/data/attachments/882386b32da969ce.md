...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a5627495 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a5627495
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a5627495"
  - tablist:
    - tab "Browse"

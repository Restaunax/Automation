...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 851a79a4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 851a79a4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 851a79a4"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 6c554d2d — Miami — Print Shop
  - paragraph: Automation Owner2 Store 6c554d2d
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 6c554d2d"
  - tablist:
    - tab "Browse"

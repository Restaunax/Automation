...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a30c8a28 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a30c8a28
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a30c8a28"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 2e4bded4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 2e4bded4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 2e4bded4"
  - tablist:
    - tab "Browse"

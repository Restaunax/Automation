...
- Name: dashboard/owner/04b-menu-availability.spec.ts >> Owner — Menu tab (availability / featured) >> TC-288: the sidebar Menu tab opens Menu Availability Management and Manage Menu opens the builder @smoke
- Location: tests/dashboard/owner/04b-menu-availability.spec.ts:101:7
...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 8b035a6a 1 Available" [level=3]:
    - button "Test Starters 8b035a6a 1 Available":
      - heading "Test Starters 8b035a6a" [level=6]
      - text: 1 Available
  - heading "Test Starters 3861751e 1 Available" [level=3]:
    - button "Test Starters 3861751e 1 Available":
      - heading "Test Starters 3861751e" [level=6]
      - text: 1 Available
  - heading "Automation Menu fa363e8a 1 Available" [level=3]:
    - button "Automation Menu fa363e8a 1 Available":
      - heading "Automation Menu fa363e8a" [level=6]
      - text: 1 Available
  - heading "Automation Menu 2ba17c60 6 Available" [level=3]:
    - button "Automation Menu 2ba17c60 6 Available":
      - heading "Automation Menu 2ba17c60" [level=6]
      - text: 6 Available
- button "Open chat"
```

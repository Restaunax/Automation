...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 09d5e70c — Miami — Print Shop
  - paragraph: Automation Owner2 Store 09d5e70c
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 09d5e70c"
  - tablist:
    - tab "Browse"

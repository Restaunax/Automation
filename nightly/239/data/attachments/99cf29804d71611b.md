...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store de912ef9 — Miami — Print Shop
  - paragraph: Automation Owner2 Store de912ef9
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store de912ef9"
  - tablist:
    - tab "Browse"

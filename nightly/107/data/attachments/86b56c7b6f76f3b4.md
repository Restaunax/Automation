...
- main:
  ...
  - img: Jul 18 Jul 21 Jul 24 Jul 27 Jul 30 Aug 2 Aug 5 Aug 8 Aug 11 Aug 14 Aug 17 $0.00 $50… $1.0… $1.5…
  - heading "Revenue Breakdown" [level=6]
  - text: Net Sales
  - heading "$13,266.08" [level=5]
  ...
  - paragraph: 🚗 DoorDash
  - paragraph: "0"
  - text: $0.00 Delivery 6% Pickup 94%
  ...
  - table:
    - rowgroup:
      - row "Code Type Used Discount Status":
        ...
        - columnheader "Status"
    - rowgroup:
      - row "AUTO0E296089 5$ 0 $0.00 ACTIVE":
        - cell "AUTO0E296089":
          - paragraph: AUTO0E296089
        - cell "5$"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      ...
      - row "ANN-CRJKTY4B 5$ 0 $0.00 ACTIVE":
        ...
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO70ACF7C3 10% 0 $0.00 ACTIVE":
        - cell "AUTO70ACF7C3":
          - paragraph: AUTO70ACF7C3
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO3E5A2D0D 5Item 0 $0.00 ACTIVE":
        - cell "AUTO3E5A2D0D":
          - paragraph: AUTO3E5A2D0D
        - cell "5Item"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO68CFA6C5 10% 0 $0.00 ACTIVE":
        - cell "AUTO68CFA6C5":
          - paragraph: AUTO68CFA6C5
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTOF946E434 10% 0 $0.00 ACTIVE":
        - cell "AUTOF946E434":
          - paragraph: AUTOF946E434
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO3DD7C465 10% 0 $0.00 ACTIVE":
        - cell "AUTO3DD7C465":
          - paragraph: AUTO3DD7C465
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTOA354E30A-COPY 10% 0 $0.00 ACTIVE":
        - cell "AUTOA354E30A-COPY":
          - paragraph: AUTOA354E30A-COPY
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTOFF895FDA 10% 0 $0.00 ACTIVE":
        - cell "AUTOFF895FDA":
          - paragraph: AUTOFF895FDA
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
  ...
  - text: Total Tips
  - heading "$571.34" [level=6]
  - text: 704.3% Avg. Tip %
  - heading "14.5%" [level=6]
  - text: Tipping Rate
  - heading "29%" [level=6]
  ...
  - table:
    ...
    - rowgroup:
      - row "1 Automation Burger 957 $12,431.43 $12.99":
        ...
        - cell "$12,431.43"
        - cell "$12.99"
      - row "2 Build Your Burger 29 $405.71 $13.99":
  ...
  - text: Averaged over 5 week
  - combobox "All Days"
  - text: 0.4 0.7 0.4 1.8 1.1 0.6 7.0 2.3 0.3 1.0 0.7 1.7 2.9 2.1 1.6 1.3 0.9 1.6 1.5 0.9 12am 3am 6am 9am 12pm 3pm 6pm 9pm 11pm Not Busy Very Busy
  ...
  - table:
    ...
    - rowgroup:
      - row "j***@restaunax-test.com 222 $2,883.78 $12.99":
        - cell "j***@restaunax-test.com"
        - cell "222"
        - cell "$2,883.78"
        - cell "$12.99"
      - row "a***@restaunax-test.com 59 $766.41 $12.99":

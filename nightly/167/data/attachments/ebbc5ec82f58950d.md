...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 021c7a7c — Miami — Print Shop
  - paragraph: Automation Owner2 Store 021c7a7c
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 021c7a7c"
  - tablist:
    - tab "Browse"

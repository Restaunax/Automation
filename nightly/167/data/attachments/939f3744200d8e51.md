...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store c40dae6a — Miami — Print Shop
  - paragraph: Automation Owner2 Store c40dae6a
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store c40dae6a"
  - tablist:
    - tab "Browse"

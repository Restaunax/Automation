...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 9af703ac — Miami — Print Shop
  - paragraph: Automation Owner2 Store 9af703ac
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 9af703ac"
  - tablist:
    - tab "Browse"

...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 1c89ff0a 1 Available" [level=3]:
    - button "Test Starters 1c89ff0a 1 Available":
      - heading "Test Starters 1c89ff0a" [level=6]
      - text: 1 Available
  - heading "Test Starters ad9c7496 1 Available" [level=3]:
    - button "Test Starters ad9c7496 1 Available":
      - heading "Test Starters ad9c7496" [level=6]
      - text: 1 Available
  - heading "Automation Menu 715c0e12 6 Available" [level=3]:
    - button "Automation Menu 715c0e12 6 Available":
      - heading "Automation Menu 715c0e12" [level=6]
      - text: 6 Available
- button "Open chat"
```

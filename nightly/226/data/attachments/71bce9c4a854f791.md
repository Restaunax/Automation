...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a2ecaf64 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a2ecaf64
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a2ecaf64"
  - tablist:
    - tab "Browse"

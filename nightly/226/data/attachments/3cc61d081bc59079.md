...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0dad1f11 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0dad1f11
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0dad1f11"
  - tablist:
    - tab "Browse"

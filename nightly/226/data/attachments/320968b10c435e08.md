...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 35f31e4e — Miami — Print Shop
  - paragraph: Automation Owner2 Store 35f31e4e
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 35f31e4e"
  - tablist:
    - tab "Browse"

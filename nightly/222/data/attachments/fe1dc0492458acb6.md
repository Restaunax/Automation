...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store fe64c8e6 — Miami — Print Shop
  - paragraph: Automation Owner2 Store fe64c8e6
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store fe64c8e6"
  - tablist:
    - tab "Browse"

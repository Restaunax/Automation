...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 56ea2bbe 1 Available" [level=3]:
    - button "Test Starters 56ea2bbe 1 Available":
      - heading "Test Starters 56ea2bbe" [level=6]
      - text: 1 Available
  - heading "Test Starters 2572e0ba 1 Available" [level=3]:
    - button "Test Starters 2572e0ba 1 Available":
      - heading "Test Starters 2572e0ba" [level=6]
      - text: 1 Available
  - heading "Automation Menu 768aba39 6 Available" [level=3]:
    - button "Automation Menu 768aba39 6 Available":
      - heading "Automation Menu 768aba39" [level=6]
      - text: 6 Available
- button "Open chat"
```

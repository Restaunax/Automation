...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0a1285bf — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0a1285bf
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0a1285bf"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 07e9ffe0 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 07e9ffe0
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 07e9ffe0"
  - tablist:
    - tab "Browse"

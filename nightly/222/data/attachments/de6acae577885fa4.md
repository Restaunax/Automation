...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store cb21fe1d — Miami — Print Shop
  - paragraph: Automation Owner2 Store cb21fe1d
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store cb21fe1d"
  - tablist:
    - tab "Browse"

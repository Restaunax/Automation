...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store c73f4eeb — Miami — Print Shop
  - paragraph: Automation Owner2 Store c73f4eeb
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store c73f4eeb"
  - tablist:
    - tab "Browse"

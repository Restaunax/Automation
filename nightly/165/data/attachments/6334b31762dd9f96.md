...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 9aa44a3a — Miami — Print Shop
  - paragraph: Automation Owner2 Store 9aa44a3a
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 9aa44a3a"
  - tablist:
    - tab "Browse"

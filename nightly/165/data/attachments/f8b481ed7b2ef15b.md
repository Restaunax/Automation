...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 9e4eaaa0 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 9e4eaaa0
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 9e4eaaa0"
  - tablist:
    - tab "Browse"

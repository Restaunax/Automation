...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 70b56a2c — Miami — Print Shop
  - paragraph: Automation Owner2 Store 70b56a2c
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 70b56a2c"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0b0f0a42 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0b0f0a42
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0b0f0a42"
  - tablist:
    - tab "Browse"

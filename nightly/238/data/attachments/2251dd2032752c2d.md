...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 96b4d391 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 96b4d391
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 96b4d391"
  - tablist:
    - tab "Browse"

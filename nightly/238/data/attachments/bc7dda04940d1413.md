...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 9d9db3de 1 Available" [level=3]:
    - button "Test Starters 9d9db3de 1 Available":
      - heading "Test Starters 9d9db3de" [level=6]
      - text: 1 Available
  - heading "Test Starters 9a4c41f7 1 Available" [level=3]:
    - button "Test Starters 9a4c41f7 1 Available":
      - heading "Test Starters 9a4c41f7" [level=6]
      - text: 1 Available
  - heading "Automation Menu 18b85a5e 6 Available" [level=3]:
    - button "Automation Menu 18b85a5e 6 Available":
      - heading "Automation Menu 18b85a5e" [level=6]
      - text: 6 Available
- button "Open chat"
```

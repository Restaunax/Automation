...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 8a51a62f — Miami — Print Shop
  - paragraph: Automation Owner2 Store 8a51a62f
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 8a51a62f"
  - tablist:
    - tab "Browse"

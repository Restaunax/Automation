...
- main:
  ...
  - heading "Test Starters 9a4c41f7 1 Available" [level=3]:
    - button "Test Starters 9a4c41f7 1 Available":
      ...
      - text: 1 Available
  - heading "Automation Menu 70b0d7ff 1 Available" [level=3]:
    - button "Automation Menu 70b0d7ff 1 Available":
      - heading "Automation Menu 70b0d7ff" [level=6]
      - text: 1 Available
  - heading "Automation Deals Storefront 4c4fdfdb 3 Available" [level=3]:
    - button "Automation Deals Storefront 4c4fdfdb 3 Available":
      - heading "Automation Deals Storefront 4c4fdfdb" [level=6]
      - text: 3 Available
- button "Open chat"
```

...
- Name: dashboard/public/01-demo-request.spec.ts >> Demo Request — Public Form >> TC-01: submit demo request form and display success confirmation
- Location: tests/dashboard/public/01-demo-request.spec.ts:19:7
...
Locator: locator('#success-dialog-title')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('#success-dialog-title')

```

```yaml
- dialog:
  - heading "Request Submitted!" [level=5]
  - paragraph: Your demo request has been received. Our team will contact you within 24 hours to schedule your personalized demo.
  - button "Close"
```

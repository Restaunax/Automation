...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 49d2d347 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 49d2d347
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 49d2d347"
  - tablist:
    - tab "Browse"

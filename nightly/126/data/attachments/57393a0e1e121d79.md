...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 99e5b3a4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 99e5b3a4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 99e5b3a4"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 8c9d5cdf — Miami — Print Shop
  - paragraph: Automation Owner2 Store 8c9d5cdf
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 8c9d5cdf"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 6d5e76e4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 6d5e76e4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 6d5e76e4"
  - tablist:
    - tab "Browse"

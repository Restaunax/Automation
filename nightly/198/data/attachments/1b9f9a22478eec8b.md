...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 062700e2 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 062700e2
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 062700e2"
  - tablist:
    - tab "Browse"

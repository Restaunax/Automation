...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 2202a33a — Miami — Print Shop
  - paragraph: Automation Owner2 Store 2202a33a
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 2202a33a"
  - tablist:
    - tab "Browse"

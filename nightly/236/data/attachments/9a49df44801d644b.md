...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a60bd9c2 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a60bd9c2
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a60bd9c2"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 589ccd8a — Miami — Print Shop
  - paragraph: Automation Owner2 Store 589ccd8a
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 589ccd8a"
  - tablist:
    - tab "Browse"

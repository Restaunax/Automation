...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 7d91b52c — Miami — Print Shop
  - paragraph: Automation Owner2 Store 7d91b52c
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 7d91b52c"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 397654f7 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 397654f7
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 397654f7"
  - tablist:
    - tab "Browse"

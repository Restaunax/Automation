...
Locator:  getByRole('button', { name: /^Automation Menu d8a37331 \d+ Available/ })
Expected: "true"
Received: "false"
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /^Automation Menu d8a37331 \d+ Available/ })
    21 × locator resolved to <button tabindex="0" type="button" aria-expanded="false" class="MuiButtonBase-root MuiAccordionSummary-root css-30sy8n">…</button>
       - unexpected value "false"

```

```yaml
- button "Automation Menu d8a37331 6 Available":
  - heading "Automation Menu d8a37331" [level=6]
  - text: 6 Available
```

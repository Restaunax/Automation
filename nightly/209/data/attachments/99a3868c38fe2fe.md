...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 9bfc6122 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 9bfc6122
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 9bfc6122"
  - tablist:
    - tab "Browse"

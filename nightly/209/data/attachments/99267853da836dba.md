...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 947085cc — Miami — Print Shop
  - paragraph: Automation Owner2 Store 947085cc
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 947085cc"
  - tablist:
    - tab "Browse"

...
- main:
  ...
  - heading "Test Starters 7f43897d 1 Available" [level=3]:
    - button "Test Starters 7f43897d 1 Available":
      ...
      - text: 1 Available
  - heading "Automation Menu 3d5d6ea2 1 Available" [level=3]:
    - button "Automation Menu 3d5d6ea2 1 Available":
      - heading "Automation Menu 3d5d6ea2" [level=6]
      - text: 1 Available
  - heading "Automation Deals Storefront 2f9fec69 3 Available" [level=3]:
    - button "Automation Deals Storefront 2f9fec69 3 Available":
      - heading "Automation Deals Storefront 2f9fec69" [level=6]
      - text: 3 Available
- button "Open chat"
```

...
- Name: pos/07-waitlist-public.spec.ts >> POS — Waitlist & Public Reservation Booking >> TC-424: per-phone cap — a second future booking on the same phone is refused
- Location: tests/pos/07-waitlist-public.spec.ts:504:7

...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 32c5186e 1 Available" [level=3]:
    - button "Test Starters 32c5186e 1 Available":
      - heading "Test Starters 32c5186e" [level=6]
      - text: 1 Available
  - heading "Test Starters 7f43897d 1 Available" [level=3]:
    - button "Test Starters 7f43897d 1 Available":
      - heading "Test Starters 7f43897d" [level=6]
      - text: 1 Available
  - heading "Automation Menu 94d7dd1e 6 Available" [level=3]:
    - button "Automation Menu 94d7dd1e 6 Available":
      - heading "Automation Menu 94d7dd1e" [level=6]
      - text: 6 Available
  - heading "Automation Menu e3a49e79 0 Available" [level=3]:
    - button "Automation Menu e3a49e79 0 Available":
      - heading "Automation Menu e3a49e79" [level=6]
      - text: 0 Available
- button "Open chat"
```

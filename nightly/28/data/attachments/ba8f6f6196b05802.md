...
- Name: dashboard/admin/demo/02-demo-actions.spec.ts >> Admin — Demo Request Actions >> TC-06: admin can change demo status via inline dropdown
- Location: tests/dashboard/admin/demo/02-demo-actions.spec.ts:115:9

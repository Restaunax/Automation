...
- Name: dashboard/admin/demo/02-demo-actions.spec.ts >> Admin — Demo Request Actions >> TC-05: admin can open the action menu on a demo row
- Location: tests/dashboard/admin/demo/02-demo-actions.spec.ts:93:9

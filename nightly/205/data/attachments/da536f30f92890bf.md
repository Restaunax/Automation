...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store d855466f — Miami — Print Shop
  - paragraph: Automation Owner2 Store d855466f
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store d855466f"
  - tablist:
    - tab "Browse"

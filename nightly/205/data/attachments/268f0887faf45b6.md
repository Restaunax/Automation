...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 18fae1ea — Miami — Print Shop
  - paragraph: Automation Owner2 Store 18fae1ea
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 18fae1ea"
  - tablist:
    - tab "Browse"

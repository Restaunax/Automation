...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store a80c6425 — Miami — Print Shop
  - paragraph: Automation Owner2 Store a80c6425
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store a80c6425"
  - tablist:
    - tab "Browse"

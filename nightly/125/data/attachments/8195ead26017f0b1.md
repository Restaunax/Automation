...
- Name: dashboard/admin/gift-card-batches.spec.ts >> Admin — Physical gift card batches >> TC-475: batch quantity is validated — 0 and 5,001 are refused before a single card is minted
- Location: tests/dashboard/admin/gift-card-batches.spec.ts:240:7

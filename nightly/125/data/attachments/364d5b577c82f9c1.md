...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store ac8111ae — Miami — Print Shop
  - paragraph: Automation Owner2 Store ac8111ae
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store ac8111ae"
  - tablist:
    - tab "Browse"

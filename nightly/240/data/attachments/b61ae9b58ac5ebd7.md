...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store bbf9f6ae — Miami — Print Shop
  - paragraph: Automation Owner2 Store bbf9f6ae
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store bbf9f6ae"
  - tablist:
    - tab "Browse"

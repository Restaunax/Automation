...
- main:
  ...
  - heading "Test Starters 2f8d3195 1 Available" [level=3]:
    - button "Test Starters 2f8d3195 1 Available":
      ...
      - text: 1 Available
  - heading "Automation Menu c0c0a1fd 6 Available" [level=3]:
    - button "Automation Menu c0c0a1fd 6 Available":
      - heading "Automation Menu c0c0a1fd" [level=6]
      - text: 6 Available
  - heading "Automation Menu 4bf4a41c 0 Available" [level=3]:
    - button "Automation Menu 4bf4a41c 0 Available":
      - heading "Automation Menu 4bf4a41c" [level=6]
      - text: 0 Available
- button "Open chat"
```

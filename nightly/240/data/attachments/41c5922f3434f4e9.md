...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 3259c7ed — Miami — Print Shop
  - paragraph: Automation Owner2 Store 3259c7ed
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 3259c7ed"
  - tablist:
    - tab "Browse"

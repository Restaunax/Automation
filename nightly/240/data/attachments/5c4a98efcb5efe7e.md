...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store b2b53eee — Miami — Print Shop
  - paragraph: Automation Owner2 Store b2b53eee
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store b2b53eee"
  - tablist:
    - tab "Browse"

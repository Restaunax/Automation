...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 7b877dca — Miami — Print Shop
  - paragraph: Automation Owner2 Store 7b877dca
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 7b877dca"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store bbf41fb2 — Miami — Print Shop
  - paragraph: Automation Owner2 Store bbf41fb2
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store bbf41fb2"
  - tablist:
    - tab "Browse"

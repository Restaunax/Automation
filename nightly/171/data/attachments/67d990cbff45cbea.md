...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0e3506c9 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0e3506c9
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0e3506c9"
  - tablist:
    - tab "Browse"

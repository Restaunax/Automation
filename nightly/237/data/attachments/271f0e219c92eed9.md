...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 2230f3f4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 2230f3f4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 2230f3f4"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0e4de008 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0e4de008
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0e4de008"
  - tablist:
    - tab "Browse"

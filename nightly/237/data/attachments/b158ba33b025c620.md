...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 2a032f0a 1 Available" [level=3]:
    - button "Test Starters 2a032f0a 1 Available":
      - heading "Test Starters 2a032f0a" [level=6]
      - text: 1 Available
  - heading "Test Starters 58693a38 1 Available" [level=3]:
    - button "Test Starters 58693a38 1 Available":
      - heading "Test Starters 58693a38" [level=6]
      - text: 1 Available
  - heading "Automation Menu c360e688 6 Available" [level=3]:
    - button "Automation Menu c360e688 6 Available":
      - heading "Automation Menu c360e688" [level=6]
      - text: 6 Available
  - heading "Automation Menu 810fe7f2 0 Available" [level=3]:
    - button "Automation Menu 810fe7f2 0 Available":
      - heading "Automation Menu 810fe7f2" [level=6]
      - text: 0 Available
- button "Open chat"
```

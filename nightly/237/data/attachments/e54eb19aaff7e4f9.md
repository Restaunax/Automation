...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 3aeddd08 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 3aeddd08
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 3aeddd08"
  - tablist:
    - tab "Browse"

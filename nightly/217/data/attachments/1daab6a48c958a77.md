...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 918de4b5 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 918de4b5
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 918de4b5"
  - tablist:
    - tab "Browse"

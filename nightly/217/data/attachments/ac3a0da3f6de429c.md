...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 951b0b3e 1 Available" [level=3]:
    - button "Test Starters 951b0b3e 1 Available":
      - heading "Test Starters 951b0b3e" [level=6]
      - text: 1 Available
  - heading "Test Starters bf347292 1 Available" [level=3]:
    - button "Test Starters bf347292 1 Available":
      - heading "Test Starters bf347292" [level=6]
      - text: 1 Available
  - heading "Automation Menu 3860a712 6 Available" [level=3]:
    - button "Automation Menu 3860a712 6 Available":
      - heading "Automation Menu 3860a712" [level=6]
      - text: 6 Available
- button "Open chat"
```

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store c9b3c8df — Miami — Print Shop
  - paragraph: Automation Owner2 Store c9b3c8df
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store c9b3c8df"
  - tablist:
    - tab "Browse"

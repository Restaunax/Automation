...
- main:
  ...
  - heading "Test Starters bf347292 1 Available" [level=3]:
    - button "Test Starters bf347292 1 Available":
      ...
      - text: 1 Available
  - heading "Automation Menu 7c42991a 1 Available" [level=3]:
    - button "Automation Menu 7c42991a 1 Available":
      - heading "Automation Menu 7c42991a" [level=6]
      - text: 1 Available
  - heading "Automation Deals Storefront 2501a2df 3 Available" [level=3]:
    - button "Automation Deals Storefront 2501a2df 3 Available":
      - heading "Automation Deals Storefront 2501a2df" [level=6]
      - text: 3 Available
- button "Open chat"
```

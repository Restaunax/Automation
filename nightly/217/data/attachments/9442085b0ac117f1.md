...
- main:
  ...
  - heading "Test Starters bf347292 1 Available" [level=3]:
    - button "Test Starters bf347292 1 Available":
      ...
      - text: 1 Available
  - heading "Automation Menu 95bbdead 6 Available" [level=3]:
    - button "Automation Menu 95bbdead 6 Available":
      - heading "Automation Menu 95bbdead" [level=6]
      - text: 6 Available
  - heading "Automation Menu cb9fd623 0 Available" [level=3]:
    - button "Automation Menu cb9fd623 0 Available":
      - heading "Automation Menu cb9fd623" [level=6]
      - text: 0 Available
- button "Open chat"
```

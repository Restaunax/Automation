...
- Name: dashboard/admin/gift-card-import.spec.ts >> Admin — Importing existing gift cards >> TC-504: the export hands back every imported balance
- Location: tests/dashboard/admin/gift-card-import.spec.ts:229:7

# Error details

```
Error: the imported card must be in the file

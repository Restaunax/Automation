...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store acdf4ea4 — Miami — Print Shop
  - paragraph: Automation Owner2 Store acdf4ea4
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store acdf4ea4"
  - tablist:
    - tab "Browse"

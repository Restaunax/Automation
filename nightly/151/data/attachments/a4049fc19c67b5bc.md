...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 74550399 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 74550399
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 74550399"
  - tablist:
    - tab "Browse"

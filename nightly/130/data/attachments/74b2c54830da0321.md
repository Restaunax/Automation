...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 941439e0 — Miami — Print Shop
  - paragraph: Automation Owner2 Store 941439e0
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 941439e0"
  - tablist:
    - tab "Browse"

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store edefcc02 — Miami — Print Shop
  - paragraph: Automation Owner2 Store edefcc02
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store edefcc02"
  - tablist:
    - tab "Browse"

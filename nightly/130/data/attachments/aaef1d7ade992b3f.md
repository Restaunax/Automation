...
- Name: dashboard/owner/20-supply-shop.spec.ts >> Owner — Print Shop (supply shop) >> TC-452: 'Looks good' moves the order to 'Placed — price confirmed at print'
- Location: tests/dashboard/owner/20-supply-shop.spec.ts:430:7
...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 0483c09d — Miami — Print Shop
  - paragraph: Automation Owner2 Store 0483c09d
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 0483c09d"
  - tablist:
    - tab "Browse"

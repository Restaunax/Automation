...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store c19cac4d — Miami — Print Shop
  - paragraph: Automation Owner2 Store c19cac4d
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store c19cac4d"
  - tablist:
    - tab "Browse"

...
- main:
  ...
  - img: Jul 16 Jul 19 Jul 22 Jul 25 Jul 28 Jul 31 Aug 3 Aug 6 Aug 9 Aug 12 Aug 15 $0.00 $50… $1.0… $1.5…
  - heading "Revenue Breakdown" [level=6]
  - text: Net Sales
  - heading "$11,036.29" [level=5]
  ...
  - paragraph: 🚗 DoorDash
  - paragraph: "0"
  - text: $0.00 Delivery 4% Pickup 96%
  ...
  - table:
    ...
    - rowgroup:
      ...
      - row "WELCOME-MD38 10% 0 $0.00 ACTIVE":
        ...
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO30A11C47 10% 0 $0.00 ACTIVE":
        - cell "AUTO30A11C47":
          - paragraph: AUTO30A11C47
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO5D33631A 10% 0 $0.00 ACTIVE":
        - cell "AUTO5D33631A":
          - paragraph: AUTO5D33631A
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO9EAEDCB4 10% 0 $0.00 ACTIVE":
        - cell "AUTO9EAEDCB4":
          - paragraph: AUTO9EAEDCB4
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
      - row "AUTO9EAEDCB4-COPY 10% 0 $0.00 ACTIVE":
        - cell "AUTO9EAEDCB4-COPY":
          - paragraph: AUTO9EAEDCB4-COPY
        - cell "10%"
        - cell "0"
        - cell "$0.00"
        - cell "ACTIVE"
  ...
  - text: Total Tips
  - heading "$499.64" [level=6]
  - text: 690.1% Avg. Tip %
  - heading "14.7%" [level=6]
  - text: Tipping Rate
  - heading "30%" [level=6]
  - img: No Tip Under 15% 15-20% Over 20% 0 200 400
  - text: Avg. Tip per Order
  - paragraph: $0.60
  - heading "Refunds & Cancellations" [level=6]
  - text: Total Refunds
  - heading "$321.60" [level=6]
  ...
  - table:
    ...
    - rowgroup:
      - row "1 Automation Burger 797 $10,377.15 $13.02":
        ...
        - cell "$10,377.15"
        - cell "$13.02"
      - row "2 Build Your Burger 28 $391.72 $13.99":
        ...
        - cell "$391.72"
        - cell "$13.99"
      - row "3 Chicken Wings 10 $149.90 $14.99":
      ...
      - row "5 Fish & Chips 4 $63.96 $15.99":
        ...
        - cell "$63.96"
        - cell "$15.99"
      - row "6 Build Your Sundae 1 $7.99 $7.99":
  ...
  - text: Averaged over 5 week
  - combobox "All Days"
  - text: 0.5 0.8 0.4 1.2 1.3 0.6 6.5 2.5 0.2 0.5 0.5 1.3 2.4 1.8 1.5 0.8 0.3 1.6 1.0 1.1 12am 3am 6am 9am 12pm 3pm 6pm 9pm 11pm Not Busy Very Busy
  ...
  - table:
    ...
    - rowgroup:
      - row "j***@restaunax-test.com 208 $2,701.92 $12.99":
      ...
      - row "n***@outlook.com 5 $155.89 $31.18":
        ...
        - cell "$155.89"
        - cell "$31.18"
      - row "a***@restaunax-test.com 11 $142.89 $12.99":

...
```yaml
- banner:
  - text: LOCATION Automation Owner2 Store 285183df — Miami — Print Shop
  - paragraph: Automation Owner2 Store 285183df
  - text: Miami, FL
...
- main:
  - paragraph: "Managing: Automation Owner2 Store 285183df"
  - tablist:
    - tab "Browse"

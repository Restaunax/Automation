...
- main:
  ...
  - heading "Automation Items 1 Available" [level=3]:
    - button "Automation Items 1 Available":
      ...
      - text: 1 Available
  - heading "Test Starters 65894cd7 1 Available" [level=3]:
    - button "Test Starters 65894cd7 1 Available":
      - heading "Test Starters 65894cd7" [level=6]
      - text: 1 Available
  - heading "Test Starters d873dfdb 1 Available" [level=3]:
    - button "Test Starters d873dfdb 1 Available":
      - heading "Test Starters d873dfdb" [level=6]
      - text: 1 Available
  - heading "Automation Menu 88b79940 1 Available" [level=3]:
    - button "Automation Menu 88b79940 1 Available":
      - heading "Automation Menu 88b79940" [level=6]
      - text: 1 Available
  - heading "Automation Menu a9cfb570 6 Available" [level=3]:
    - button "Automation Menu a9cfb570 6 Available":
      - heading "Automation Menu a9cfb570" [level=6]
      - text: 6 Available
- button "Open chat"
```

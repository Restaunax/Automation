...
- Name: pos/07-waitlist-public.spec.ts >> POS — Waitlist & Public Reservation Booking >> TC-422: manage cancel — DELETE cancels once; a repeat DELETE is a 409 conflict, not a 400
- Location: tests/pos/07-waitlist-public.spec.ts:430:7

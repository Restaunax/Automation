...
- dialog "Fulfil MP-2026-0002":
  ...
  - text: "14 day lead · min 100 · Upload the batch export (Card export on the order) as the data file: barcode_value → Code-128 on the back, code_display → the number printed beneath it, qr_value → a QR beside the Code-128 (same value). Blind-ship to the restaurant. Confirm the exact barcode placement on the first proof."

...
- Name: dashboard/admin/supply-shop.spec.ts >> Admin — Supply shop >> TC-465: an owner can never comp their own order, and cannot claim the free tier on a $207 run
- Location: tests/dashboard/admin/supply-shop.spec.ts:579:7

# Error details

```
Error: {"success":false,"code":"FREE_TIER_UNAVAILABLE","error":"This month's free item has already been used."}

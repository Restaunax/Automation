...
| Owner orders                                      | `dashboard/owner/06-orders.spec.ts`                                                                | Orders tab loads, search bar + filters visible; empty-state search, Filters panel, order detail view; status change via "Mark as X"; cancelling a Stripe-paid order triggers a real refund (the only reachable refund path — the standalone Refund dialog is dead code)                                                                                                                                                                                                                              |

...
| Suite                                      | Key cases                                                                                                                                                                                                                                                                              |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Menu — follow-ups                          | Flip the 🔴 pins when fixed (TC-282 chain reset, TC-283..286 IDOR, TC-317 Reset all to shared); RestauNax frontend testids for the chain chips / $ / carry icons (POMs already fall back to accessible names); admin link wizard UI (keep/adopt) on top of the TC-323/324 API contract |

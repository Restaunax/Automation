...
test.describe("Customer — Gift Cards", () => {
  ...
  test(
    "TC-165: guest purchases a gift card as a Send-as-Gift preset denomination",
    {
      tag: "@email",
    },
    async ({ page }) => {
  ...
  test(
    "TC-166: guest purchases a gift card with a custom amount",
    {
      tag: "@email",
    },
    async ({ page }) => {
  ...
  test(
    "TC-169: balance check shows the correct balance for a freshly purchased card",
    {
      tag: "@email",
    },
    async ({ page }) => {

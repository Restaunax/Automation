...
test.describe("Customer — Menu Browsing", () => {
  ...
  test("TC-22: customer can reach the menu page for the seed restaurant", async ({ page }) => {
    ...
    await allure.step(`Navigate to menu (restaurantId: ${restaurantId})`, async () => {
  ...
  test("TC-23: customer can open the seed menu item modal and see Add to Cart button", async ({ page }) => {
    await allure.description(

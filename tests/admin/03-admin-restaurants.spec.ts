...
import { createAdminRestaurantsPage } from "../../pages/admin/AdminRestaurantsPage";
...
test.describe("Admin — Restaurant Management", () => {
  ...
  test("TC-32: admin can navigate to the Restaurants tab and see the list", async ({ adminPage }) => {
    ...
    await allure.step(`Verify seed restaurant "${restaurantName}" row is visible`, async () => {
